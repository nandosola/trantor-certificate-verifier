...
package cc.abstra.trantor.security.utils;
...
public final class Base64Coder {
	...
	public static byte[] decode(Object input) {
		...
		if (input instanceof String) {
			...
			throw new IllegalArgumentException("Base64 input not properly padded");
		}
		int iLen = in.length;
		if (iLen % 4 != 0) {
			throw new IllegalArgumentException(APIConstants.I18N_TOOLS_CP_18);
		}
		...
		while (ip < iLen) {
			...
			if (i0 > 127 || i1 > 127 || i2 > 127 || i3 > 127) {
				throw new IllegalArgumentException(APIConstants.I18N_TOOLS_CP_19);
			}
			int b0 = map2[i0];
			int b1 = map2[i1];
			int b2 = map2[i2];
