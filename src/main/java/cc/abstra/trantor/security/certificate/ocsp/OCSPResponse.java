...
public class OCSPResponse
{
	...
	public enum ESTADOS_RESPUESTA {SUCCESSFUL, MALFORMED_REQ, INTERNAL_ERROR, TRY_LATER, SIG_REQUIRED, UNAUTHORIZED }; // TODO: inyectar este valor en un campo interno

	private int 						nroRespuesta = OCSPConstants.INTERRUPTED; // Por defecto
	private String						mensajeRespuesta = OCSPConstants.MENSAJE_INTERRUMPIDO; // Por defecto
	 ...
	 */
	public OCSPResponse(int nroRespuesta, String mensajeRespuesta)
	{
